...
namespace FitnessTracker.Models
{
    ...
    {
        private readonly string youtubeApiKey = "AIzaSyBQ1G_Kei2BSW3veNJaWpWyiRLTD7ORqNk";
        ...
        public async Task<Workout?> _RandomWorkout(Workout oWorkout)
        {
            ...
            searchListRequest.Q = $"{randomWorkout.WorkOut} workout"; // Search for workout-related videos
            searchListRequest.MaxResults = 1; // Get only one video
